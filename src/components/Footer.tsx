        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Passionate software developer showcasing projects from 42 Malaga's rigorous curriculum 
              and innovative AI agent development. Always learning, always building.
            </p>
          </div>
        </div>
